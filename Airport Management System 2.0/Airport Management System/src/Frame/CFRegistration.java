...
public class CFRegistration implements ActionListener, MouseListener {
    ...
    JButton Proceed;
    CargoFlightDetails p5 = new CargoFlightDetails();
    String fnumber, dtime, atime, dport, aport, fclass, fname, fcost;

    public CFRegistration() {
        ...
        label2 = new JLabel("Flight Name");
        label2.setBounds(200, 390, 250, 50);
        label2.setFont(font);
        label2.setForeground(Color.DARK_GRAY);
        label2.setBackground(Color.RED);

        label4 = new JLabel("Flight Cost");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Proceed) {
            ...
            if (fnumber.isEmpty() == false && dtime.isEmpty() == false && atime.isEmpty() == false
                    && dport.isEmpty() == false &&
                    aport.isEmpty() == false && fname.isEmpty() == false
                    && fcost.isEmpty() == false) {
                String data = "\n\n\n        Flight Number : " + tf2.getText() + "\n"
                        + "\n       Departure Time : " + tf3.getText() + "\n";

                data += "        Arrival Time : " + tf4.getText() + "\n" + "        Departure Airport : "
                        + tf5.getText() + "\n";
                data += "        Arrival Airport : " + tf6.getText() + "\n" + "        Flight Name : " + tf7.getText()
                        + "\n";
                data += "        Flight Cost : " + tf8.getText() + "\n";
